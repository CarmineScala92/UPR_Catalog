...
/**
 * Servlet implementation class CaricamentoListaProdottiAccettatiServlet
 * Si occupa di caricare i prodotti accettati e li ritorna in formato XML
 */
@WebServlet("/CaricaListaProdottiAccettatiServlet")
public class CaricaListaProdottiAccettatiServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			lista = supportoValidazioneManager.caricaListaProdottiAccettati();
		}
