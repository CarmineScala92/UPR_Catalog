...
<%@ page import="it.unisa.upr.data.gestioneAutenticazione.Account"%>
	...
	<%
		...
		if (am != null) {
			response.sendRedirect("gestione_Utenti.jsp");
		}
  ...
  <div class="navbar navbar-default navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-collapse collapse">
      ...
      <div class="navbar-right row" style="margin-top:10px; margin-right:10px">
        ...
        <!-- <label style="color: darkred">Errore Autenticazione</label>-->
        ...
        <script  type="text/javascript">
         ...
         lanciaNotifica();
          ...
          <button type="submit" class="btn btn-primary input-sm"><span class="glyphicon glyphicon-user"></span>Logn</button>
        </form>
      </div>
   ...
   <!--gestione notifica ...vedere anche nel  index.js--> 
  
  <div id="notificaLogin" class="col-xs-6 col-xs-offset-3 alert alert-danger fade in" hidden style="margin-top:50px">
