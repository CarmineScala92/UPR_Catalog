...
<body>
 ...
 <div class="navbar-right row" style="margin-top:10px; margin-right:10px">
  ...
  <%} %>
	...
	<input class="form-control" type='hidden' id="ID_Proprietario" value="<% out.print(idRic); %>" name="ID_Proprietario" />
	...
	<div class="col-xs-offset-3 col-xs-7" style="padding-top:20px;padding-bottom:20px;" id="divBack">
		<button class="btn btn-warning" onclick="location.href='./index.jsp'" id="historyBack">Indietro</button>
	</div>
