...
<script src="js/InserimentoDipartimento.js"></script> 
</head>
<body>
...
<div class="row page-header   col-xs-offset-0 " style="margin-top:51px; text-align:center">
  <h1>Gestione Dipartimenti </h1><h2><small>Questa pagina permette di inserire un  nuovo dipartimento.</small></h2>
  </div> <!-- div gestione utenti -->

  <form class="row form-horizontal row" style="margin-top: 102px" method="post" action="./InserisciDipartimentoServlet" id="form" name="formVisualizza">  
  <div class="form-group" id="Div_Nome">
	 ...
	 <div class="form-group" id=divSito>
	  ...
	  <input name="ID_Dipartimento" value="<% out.print(request.getParameter("id")); %>" hidden> <!-- ha un campo nascosto in piu -->
			...
			<div>
			<button name="bottoneConferma" id="bottoneConferma" type="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary" style="margin-left:290px ;margin-top:50px" onclick="controlloInvioDati()">Conferma Inserimento</button>
			<button  id="bottoneAnnulla" type="button" class="btn btn-primary " style="margin-left:570px;margin-top:50px" onclick="tornaAGestioneAteneo()">Annulla</button>
			</div>
 ...
 <div class="row modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="vertical-align:middle">
      ...
      <div class="modal-header">
        ...
        <h4 id="h4" class="modal-title" id="myModalLabel">Inserimento Dipartimento</h4>
      </div>
      ...
      <div class="modal-footer">
       ...
       <button id="bottoneAnnull" type="button" class="btn btn-default" data-dismiss="modal">Annulla</button> 
       </div>
      <div style="display: inline-block;">
