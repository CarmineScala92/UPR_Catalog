...
<title>Modifica area scientifica</title>
</head>
...
<div class="row navbar navbar-default navbar-fixed-top" role="navigation">
  ...
  <h1 id="NomeArea"> </h1><h2><small>In questa pagina è possibile modificare i campi di un' Area Scientifica</small></h2>
 ...
 <input id="idArea" value="<% out.print(request.getParameter("id")); %>" hidden>
 <form class="row form-horizontal row" style="margin-top: 102px" method="post" action="./ModificaAreaScientificaServlet" name="formVisualizza">  

<!-- <button class="btn btn-primary" style="margin-left: 1100px; margin-top: -50px">Inserisci area Scientifica</button> -->
  ...
  <div class="form-group" id="Div_Nome">
	 ...
	 <input name="ID_Area_Scientifica" value="<% out.print(request.getParameter("id")); %>" hidden>
	
			<div><button id="bottoneModifica" type="button" data-toggle="modal" data-target="#myModal" class="btn btn-success" style="margin-left:290px ;margin-top:50px" onclick="controlloInvioDati()">Conferma Modifica</button>
			<button  id="bottoneElimina" type="button" class="btn btn-danger " style="margin-left:570px;margin-top:50px" onclick="tornaIndietro()">Annulla</button></div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="vertical-align:middle">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="h4">Modifica Area Scientifica</h4>
      </div>
      <div class="modal-body">
        <p id="p">Sei sicuro di voler modificare l'area scientifica?</p>
      </div>
...
<script src="js/jquery.js"></script> 
	...
	<script type="text/javascript">
		...
		function lanciaNotifica(){
			$(".alert").show();
			$(".alert-msg").html('<strong>Errore!</strong> l\'area scientifica non può essere modificata');
