...
<title>Visualizza Dipartimento</title>
...
<div class="row navbar navbar-default navbar-fixed-top" role="navigation">
  ...
  <h1 id="nomeDip">   <h1><h2><small>In questa pagina è possibile visualizzare i dati relativi  ad un Dipartimento</small></h2>
  ...
  <div class="row form-horizontal row" style="margin-top: 40px"> 
  <div class="form-group">
	 ...
	 <div class="form-group">
		...
		<span class="help-inline"></span>
			...
			<button id="bottoneModifica" type="button" class="btn btn-primary" style="margin-left:290px ;margin-top:50px" onclick="modificaDipartimento()" >Modifica dipartimento</button>
			
			
			</div>
			<div style="display: inline-block;">
			
			<button  id="bottoneElimina" type="button" data-toggle="modal" data-target="#myModal" class="btn btn-danger " style="margin-left:370px;margin-top:50px">Elimina dipartimento</button>
	 ...
	 <div class="row modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="vertical-align:middle">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Elimina Dipartimento</h4>
      </div>
      <div class="modal-body">
        <p>Sei sicuro di voler eliminare il dipartimento?</p>
      </div>
      ...
      <div style="display: inline-block;">
        ...
        <div style="display: inline-block;">
        <form method="post" action="./EliminaDipartimentoServlet">
		<input id="idDipartimento" name="ID_Dipartimento" value="<% out.print(request.getParameter("id")); %>" hidden/>
   ...
   %>
   		...
   		<script type="text/javascript">
   		lanciaNotifica("Errore","Il dipartimento non può essere eliminato perchè ci sono ricercatori associati");
   ...
   <%if(session.getAttribute("Response")!=null){
	   session.removeAttribute("Response");%>
   		...
   		lanciaNotifica("Ben fatto!","il dipartimento è stato modificato con successo");
   		</script>
